...
<!-- =================== ENTETE DE LA PAGE =========================================  -->
	<div id="Chapeau_court">
		<h1>
		This page gives an overview of the features of the GPAC project and a short list of the supported tools.
		</h1>
	</div>
...
<!-- =================== CORPS DE LA PAGE ============================================  -->
	<div id="Centre">
      ...
      <?php include_once("home_left.php"); ?>
        ...
        <p>
          GPAC officialy started as an open-source project  in 2003 with the initial goal to develop from scratch, 
          ...
          Since then, the project has evolved and features now three sets of tools: 
          <ul>
        ...
        <p>
          ...
          around the world to have a look at GPAC and bring in valuable help and 
          feedback.
        </p>
			</div>
	</div>
