...
<title>GPAC Player Documentation - GPAC Project on Advanced Content</title>
...
<li><a href="#Render3D">Render3D</a></li>
<li><a href="#Render2D">Render2D</a></li>
<li><a href="#Rendering">Rendering</a></li>
<li><a href="#Systems">Systems</a></li>
<li><a href="#RecentFiles">RecentFiles</a></li>
...
<li><a href="#ISOReader">ISOReader</a></li>
<li><a href="#FFMPEG">FFMPEG</a></li>
<li><a href="#SAXLoader">SAXLoader</a></li>
<li><a href="#StreamingCache">Cache</a></li>
...
<br>
<b><span style="font-size: 18pt;">Last Modified May 2007</span></b>
</p>
...
<br>A section is declared as <b><i>SectionName</i></b>. 
...
<b><a href="#Rendering" style="text-decoration: underline;">Rendering</a></b>

<b><a href="#Render2D" style="text-decoration: underline;">Render2D</a></b>
<b><a href="#Render3D" style="text-decoration: underline;">Render3D</a></b>
...
<p>
The <b>General</b> section of the config file holds player specific options. This section is not used by GPAC core engine.
...
<b>LogLevel</b> [value: <i>"none", "error", "warning", "info", "debug"</i>]
<p style="text-indent: 5%;">
...
<li><i>render</i> : renderng engine (2D, 3D, etc)</li>
...
<b>AlwaysDrawBIFS</b> [value: <i>"yes" "no"</i>]
<p style="text-indent: 5%;">
...
<a name="Rendering"></a>
<span style="text-decoration: underline;"><b>Section "Rendering"</b></span> <i><a href="#Overview">Back to top</a></i>
<p>
The "Rendering" section of the config file holds all configuration options for the logical rendering engine.
</p>

<b>RendererName</b> [value: <i>string</i>]
<p style="text-indent: 5%;">
...
and by the 3D renderer for text texturing and gradients compute.</p>
...
<b>FastRender</b> [value: <i>"yes" "no"</i>]
<p style="text-indent: 5%;">
...
<p style="text-indent: 5%;">
Specifies that the renderer runs in worst case scenario, recomputing all vectorial paths, outline or display lists and reloading textures (sending them to graphics card) at each frame.</p>
...
<a name="Render2D"></a>
<span style="text-decoration: underline;"><b>Section "Render2D"</b></span> <i><a href="#Overview">Back to top</a></i>
<p>
The "Render2D" section of the config file holds all configuration options for the 2D tile rendering engine and hardware.
</p>
<b>DirectRender</b> [value: <i>"yes" "no"</i>]
<p style="text-indent: 5%;">
...
<br><br>
<a name="Render3D"></a>
<span style="text-decoration: underline;"><b>Section "Render3D"</b></span> <i><a href="#Overview">Back to top</a></i>
<p>The "Render3D" section of the config file holds all configuration options for the 3D rendering engine and OpenGL hardware.</p>
...
<b>BitmapCopyPixels</b> [value: <i>"yes" "no"</i>]
<p style="text-indent: 5%;">
...
bitmap depending on the graphics card. Some cards will have faster pixel copy routines that texture transfer ones, some won't.</p>
...
<b>DriverName</b> [value: <i>string</i>]
<p style="text-indent: 5%;">
Specifies the driver to use for font handling. This driver cannot be reloaded at run-time, the complete system must be restarted.</p>
...
<b>TextureTextMode</b> (value: <i>"Never", "3D", "Always"</i>]
<p style="text-indent: 5%;">
Specifies whether text shall be drawn to a texture and then rendered or directly rendered. Using textured text can improve text look in the 3D renderer and also improve text-on-video like content.</p>
...
<b>RestartFiles</b> [value: <i>"yes" "no"</i>]

<p style="text-indent: 5%;">
Specifies whether incompletely downloaded files shall be removed before redownloading.</p>
