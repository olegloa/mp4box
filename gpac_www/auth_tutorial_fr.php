...
<object data="http://perso.enst.fr/~concolat/MPEG-4/tutorial.html" type="text/html" width="100%" height="600px" style="files/styles.css">
...
<?php $mod_date="\$Date: 2007-07-27 05:38:14 $"; ?><?php include_once("bas.php"); ?><!-- =================== FIN CADRE DE LA PAGE =========================================  --></div></body></html>
