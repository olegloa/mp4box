	...
	<div id="Centre">
      ...
      <?php include_once("play_left.php"); ?>
        ...
        <ul>        
          ...
          of attributes (parsing, dump, cloning ...). It also handles the animations and scripting features of SVG.<br>If you check out the source code, look for svg_nodes.h, scenegraph_svg.h, <a href="http://gpac.svn.sourceforge.net/viewvc/gpac/trunk/gpac/src/scenegraph/">src/scenegraph</a>/svg_*.*.</p>
          ...
          platforms, and the GPAC 2D Rasterizer, based on FreeType.<br>If you check out the source code, look for <a href="http://gpac.svn.sourceforge.net/viewvc/gpac/trunk/gpac/src/compositor">src/compositor</a>/svg*.c. </p>
        </ul>
